...
Usage (one language):
    python run_top_terms.py \\
        --input ../../steam-data/step03-output-pt/tfidf_lexicon_pt.csv \\
        --output ../../steam-data/step03-output-pt/top_terms_pt.csv

Usage (both, in one call):
    python run_top_terms.py \\
        --input ../../steam-data/step03-output-pt/tfidf_lexicon_pt.csv \\
        --input ../../steam-data/step03-output-en/tfidf_lexicon_en.csv \\
        --output ../../steam-data/step03-output/top_terms.csv
"""
import argparse
